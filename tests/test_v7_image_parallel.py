...
from conceptgraph.slam.v7_request_cache import EvidenceRequestCache
...
class Stages(unittest.TestCase):
    def setUp(self):
        ...
        self.r.request_cache=EvidenceRequestCache(self.root/"request_cache")
        self.r.endpoint_pool=EndpointPool(URLS,1,max_timeout_retries=0);self.thread=threading.get_ident();self.publish_count=0
        def publish():
