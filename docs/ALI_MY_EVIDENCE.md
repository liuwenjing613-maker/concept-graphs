...
The concrete Replica room0 smoke evidence is archived under
`artifacts/evidence/replica_room0/ali_my_evidence_smoke_20260817/`, including
the exact JSON/JSONL records, NPZ sidecars, Hydra configs, and `SHA256SUMS`.
